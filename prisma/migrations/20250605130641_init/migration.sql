-- CreateEnum
CREATE TYPE "UseSex" AS ENUM ('MALE', 'FEMALE');
...
-- AddForeignKey
ALTER TABLE "AssessmentResult" ADD CONSTRAINT "AssessmentResult_gradedById_fkey" FOREIGN KEY ("gradedById") REFERENCES "Teacher"("id") ON DELETE SET NULL ON UPDATE CASCADE;
